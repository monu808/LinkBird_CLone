  ...
  try {
    ...
    for (let i = 0; i < 750; i++) {
      ...
      const lead = {
        ...
        lastContactDate: undefined as Date | undefined,
        responseDate: undefined as Date | undefined,
      }

      // Add contact dates based on status
      if (status !== 'pending') {
...
seedDatabase()
  ...
  .catch((error) => {
    ...
    process.exit(1)
        ...
        notes: 'Sent initial message today.',
      },
      {
        firstName: 'Surdeep',
        lastName: 'Singh',
        ...
        userId: '1',
        lastContactDate: new Date(),
        notes: 'Interested in learning more about our offerings.',
      },
      {
        firstName: 'Anupriya',
        lastName: 'Sharma',
        email: 'anupriya@skincare.com',
        company: 'SkinCare Co',
        position: 'Brand Manager',
        status: 'responded',
        campaignId: sampleCampaigns[1].id,
        userId: '1',
        lastContactDate: new Date(Date.now() - 86400000), // 1 day ago
        responseDate: new Date(),
        notes: 'Very interested! Wants to discuss partnership opportunities.',
      },
      {
        firstName: 'Utkarsh',
        lastName: 'Kumar',
      ...
      },
      {
        ...
        campaignId: sampleCampaigns[1].id,
        userId: '1',
        lastContactDate: new Date(Date.now() - 172800000), // 2 days ago
        responseDate: new Date(Date.now() - 86400000), // 1 day ago
        notes: 'Very interested! Converted to client.',
      },
      {
        firstName: 'Deepak',
        lastName: 'Kumar',
        ...
        campaignId: sampleCampaigns[1].id,
        userId: '1',
        lastContactDate: new Date(Date.now() - 259200000), // 3 days ago
        notes: 'Not interested at the moment.',
      },
    ]).returning()

    console.log('Created leads:', sampleLeads)
    console.log('Database seeding completed successfully!')
